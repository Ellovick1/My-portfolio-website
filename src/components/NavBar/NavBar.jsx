        ...
        <div className="navbar-wrapper">
            ...
            <div className={hamburgeropen ? 'right open' : 'right'}>
                ...
                <div className="social-icon">
                    <a href="https://www.linkedin.com/in/ezekiel-elom" target="_blank"><i className="fa-brands fa-linkedin"></i></a>
                    <a href="https://github.com/ellovick1" target="_blank"><i className="fa-brands fa-github-alt"></i></a>
                    <a href="https://x.com/ellovick" target="_blank"><i className="fa-brands fa-twitter"></i></a>
